...
sampleinfo_file_names = ["../recombination/filtering/data/sampleInfo.txt"]
all_fasta_file_name = "fastas/extractedSeqs.fa" 
reference_file_name = "fastas/reference.fa"
...
for i in range(how_many_to_see):
	a_file = open("fastas/OrderedRecombs/%d.fa" % i, 'w')
