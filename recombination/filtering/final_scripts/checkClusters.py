...
def checkClusters():
    ...
    goodTrios = {}
    with open('recombination/filtering/data/combinedCatOnlyBestWithPValsFinalReportWithInfSites.txt') as f:
        for line in f:
            splitLine = (line.strip()).split('\t')
    ...
    print(counter)
    open('recombination/filtering/data/combinedCatOnlyBestWithPValsFinalReportWithInfSitesNoClusters.txt','w').write(myOutString)
