...
recombination_file_name = "../recombination/filtering/data/combinedCatOnlyBestWithPVals.txt"
sampleinfo_file_name = "../recombination/filtering/data/sampleInfo.txt"
relevent_sites_file_name = "../recombination/filtering/data/allRelevantNodesInfSites.txt"
...
dna = open("fastas/AlignedRecombs/%d.fa" % index_to_check)
