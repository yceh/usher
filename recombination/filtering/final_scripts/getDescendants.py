...
def getNClosest():
    ...
    with open('recombination/filtering/data/allRelevantNodes.txt') as f:
        for line in f:
    ...
    #TODO: Using old version of sample_paths...need to fix this for new matUtils sample_paths format
    ...
    open('recombination/filtering/data/allRelevantNodesToDescendants.txt','w').write(myOutString)
    open('recombination/filtering/data/allDescendants.txt','w').write(allDescendants)
