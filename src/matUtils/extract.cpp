...
void extract_main (po::parsed_options parsed) {
    ...
    std::vector<std::string> outs = {sample_path_filename, clade_path_filename, all_path_filename, tree_filename, output_mat_filename, output_tax_filename, json_filename, used_sample_filename, node_stats_filename};
